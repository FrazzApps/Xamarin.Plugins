...
using FrazzApps.Xamarin.Geolocator.WinU;
using Xamarin.Forms;

[assembly: Dependency(typeof(FrazzApps.Xamarin.Geolocator.WinU.Geolocator))]
namespace FrazzApps.Xamarin.Geolocator.WinU
{
